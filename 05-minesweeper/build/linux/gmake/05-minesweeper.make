...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/05-minesweeperd
...
ifeq ($(config),profile64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/05-minesweeperp
...
ifeq ($(config),release64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/05-minesweeper
  DEFINES   +=
  INCLUDES  += -I$(ORX)/include -I../../../include/Scroll -I../../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) -ffast-math -g -msse2 -O2 -m64 -Wno-unused-function -fschedule-insns
...
$(OBJDIR)/05-minesweeper.o: ../../../src/05-minesweeper.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
